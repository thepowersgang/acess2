...
Jim Boemler (jboemler@halcyon.com)
  ...
  This header created on Thu Jul 15 19:52:40 PDT 2010
...
//	{ 0x8086, 0x2653&CC_0106, "82801FBM", "AHCI Controller" } ,
	...
	{ 0x8086, 0x266D, "czc82809kr", "http://service.marasst.com/Compal/DL75/HDL75%20driver%20Ver%2002/Modem.zip" } ,
	{ 0x8086, 0x266d, "ICH6 Chipset", "Agere System AC'97 Modem " } ,
...
//	{ 0x8086, 0x27d8xzx, "PCI\\VEN_8086&DEV_27D8&SUBSYS_02D61028&REV_01\\3&61A", "Microsoft UAA Bus HD Audio" } ,
...
//	{ 0x8086, 0x29B4&subys, "4F4A8086&rev_02", "controleur pci de communications simplifies" } ,
	...
	{ 0x8086, 0x2E32, "PCI\\VEN_8086&DEV_2E32&SUBSYS_31031565&REV_03\\\3&115", "Intel G41 express graphics" } ,
	...
	{ 0x8086, 0x3B67, ".", "Intel(R) Active Management Technology - Serial Over LAN (SOL) " } ,
...
//	{ 0x1814, 0x0201 (3), "RT2560F", "RaLink" } ,
	...
	{ 0x1814, 0x0302, "RT2525 2.4GHz transceiver + RT2560 MAC/BBP", "wireless p/n" } ,
...
//	{ 0x1180, 0xE2030, "unknown", "Ricoh PCIe Memory Stick Host Controller" } ,
	...
	{ 0x14F1, 0x14F1, "14F12F20", "Conextant High Definition Audio_Venice5051" } ,
...
//	{ 0x14F1, 0x5051_, "DG31PR", "Realtek High Definition audio" } ,
//	{ 0x14F1, 0x5051__, "CX20561", "Conexant High Definition SmartAudio 221" } ,
//	{ 0x14F1, 0x5066, "Cx20561", "HDAUDIO\Func_01&VEN_14F1&DEV_5066&SUBSYS_17AA4002&REV_1003" } ,
	{ 0x14F1, 0x5B7A, "Belived to be a CX23416", "Single-Chip MPEG-2 Encoder with Integrated Analog Video/Broadcast Audio Decoder" } ,
	{ 0x14F1, 0x8800, "23888", "Video Capture (NTSC)" } ,
	...
	{ 0x0c45, 0x0C45, "USB\\VID_0C45&PID_602C\5&1BE3EA80&0&3", "USB webcam" } ,
	{ 0x0c45, 0x602D, "usb\\Vid_oc45&pid_613b\5&263791cd&0&1", "USB Webcam" } ,
...
//	{ 0xeb1a, 0x2870, "Pinnacle e70", "TV DVB-T" } ,
	{ 0x46d, 0x0804, "Webcam c250", "Camera" } ,
	...
	{ 0x168C, 0x0013, "AR2312", "802.11a/b/g Wireless Adapter" } ,
	...
	{ 0x168C, 0x001c, "AR5007EG", "Atheros AR5007EG WiFi Chip" } ,
//	{ 0x168C, 0x001C other, "AR5BXB63", "Atheros AR5007EG WiFi Chip" } ,
	...
	{ 0x168C, 0x14F1, "nForce6100-430  ", "PCI\\VEN_14f1&DEV_10b6&SUBSYS_10b614f&REV_89" } ,
...
//	{ 0x1002, 0x4380&CC_0106, "ATI RS690", "AHCI Controller" } ,
	...
	{ 0x1002, 0x94B5, "AA38", "ATI Radeon HD 4350" } ,
...
//	{ 0x1039, 0, "", "" } ,
	...
	{ 0x1039, 0x6325, "pc&#305;\\VEN_1039&DEV_6330", "Sis 650  Integrated GFX Controller  (IGP)" } ,
...
//	{ 0x103C, 0x0180000a, "0x00000000", "HID Keyboard Device" } ,
	...
	{ 0x104C, 0x803B, "PCI\\VEN_104C&DEV_803B&SUBSYS_207C17AA&REV_00", "Texas Instruments an Integrated FlashMedia Controller" } ,
	...
	{ 0x104C, 0xAC13, "PCI9066", "PCI\\VEN_104C&DEV_803B&SUBSYS_ 01071025&REV_00" } ,
	...
	{ 0x13F6, 0x0211, "PCI\\VEN_13F6&DEV_0111&SUBSYS_56421462&REV_10\\3&61A", "HSP56 MICROMODEM" } ,
...
//	{ 0x109E, 0x36E, "CONEXANT FUSION 878A 25878-13 E407702", "conexant 878a" } ,
//	{ 0x109E, 0x36E, "Bt360 MediaStream Controller", "Brooktree Corp" } ,
	...
	{ 0x10B5, 0x8664, "PEX 8664", "64-Lane, 16-Port PCI Express Gen 2 (5.0 GT/s) Switc, 35 x 35mm FCBGA" } ,
...
//	{ 0x10DF, 0xf900, "1", "FC HBA" } ,
	...
	{ 0x10EC, 0x0662, "ALC662", " Realtek HD Audio" } ,
...
//	{ 0x10EC, 0x0139, " 0200", " " } ,
	...
	{ 0x10EC, 0x0882, "ALC882", "Realtek 7.1+2 High Definition Audio" } ,
	...
	{ 0x1102, 0x0007, "C6SB0410515017656A", "Device ID same for bot, but Subsystem ID = 0x1012 - Extreme Audio, 0x100A - Audigy SE 7.1" } ,
	...
	{ 0x1106, 0x0505, "3149", "VLB to PCI Bridge" } ,
	...
	{ 0x14E4, 0x16C7, "BCM 94312", "Gigabit Ethernet" } ,
	...
	{ 0x14E4, 0x4320, "BCM4310", "802.11b/g Wireless LAN Controller" } ,
	...
	{ 0x1131, 0x7160, "Philips SAA7134E, TDA10046 and TDA8275A", "PCI\\VEN_13D0&DEV_2103&SUBSYS_210313D0&REV_02\\4&1AF1648C&0&10F0" } ,
...
//	{ 0x1145, 0xF021, "????", "HDCClassName=" } ,
	...
	{ 0x1166, 0x0008, "NB6536 (CNB20-HE)", "Hostbridge & MC, bus/dev/func 0/0/0" } ,
...
//	{ 0x1166, 0x0241, "RC5000Series&BC48?(4850L&4852...)", "ServerWorks Frodo4 SATA RAID Controller" } ,
	...
	{ 0x1179, 0x0805, "PCI\\VEN_1179&DEV_0805&SUBSYS_FF001179&REV_03  ", "SD Card Controller" } ,
	...
	{ 0x11AB, 0x4357, "0", "marvell ethernet lan No painel " } ,
...
//	{ 0x0070, 0x6800, " PCI\\VEN_1131&DEV_7130&SUBSYS_40510000&REV_01\\4&3B", "Hauppage Nova -TD-500 DVB-T Tuner Device" } ,
	...
	{ 0x11BD, 0x11FE, "49", "ordinateur portable" } ,
